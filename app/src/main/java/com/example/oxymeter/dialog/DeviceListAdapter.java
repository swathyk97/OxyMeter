package com.example.oxymeter.dialog;
...
public class DeviceListAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvName = llItem.findViewById(R.id.tvBtItemName);
        TextView tvAddr = llItem.findViewById(R.id.tvBtItemAddr);
